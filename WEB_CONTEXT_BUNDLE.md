...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-195-erd-s-problem-195-edcbdaad-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-195"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-195-erd-s-problem-195-edcbdaad-v1",
      "problem_contract_sha256": "7903dc5bbfbcb51db61326c88961b901483f75b0085c3f4f974ee414b155e522",
      "problem_id": "problem:um-ep-195-erd-s-problem-195-edcbdaad",
      "route_id": "route:um-ep-195-erd-s-problem-195-edcbdaad-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-195-erd-s-problem-195-edcbdaad-source-fidelity-01",
      "graph_id": "graph:um-ep-195-erd-s-problem-195-edcbdaad-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-195-erd-s-problem-195-edcbdaad-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-195-erd-s-problem-195-edcbdaad-root",
          "statement": {
          ...
          "statement_sha256": "5c08c1fc24a61e6c100b87237f5ca816212bc9f5e37e997710bf05d480e79aae"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-195-erd-s-problem-195-edcbdaad-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-195-erd-s-problem-195-edcbdaad-root",
      "route_id": "route:um-ep-195-erd-s-problem-195-edcbdaad-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-195-85355cb2b865",
        "url": "https://www.unsolvedmath.com/problems/EP-195"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
